        ...
        public String BuscarParaLogin(String id,String pass,ABBE raiz)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    return "1,"+raiz.getNombre()+","+raiz.getApellido();
                }
                else
        ...
        public String agregar(String id,String pass,String nombre,String apellido)
        {
            ...
            else  if (this.Comparador(id,this.raiz.getID()) < 0)//nick es menor que la raiz
            {
                ...
                {
                  String res = this.raiz.getIz().agregar(id,pass,nombre,apellido);
                  ABBE son = this.raiz.getIz();
            ...
            else if (this.raiz.Comparador(id,this.raiz.getID()) > 0)
            {
                ...
                {
                  String res = this.raiz.getDer().agregar(id,pass,nombre,apellido);
                  ABBE son = this.raiz.getDer();
                  this.raiz.setFe(this.Altura(this.raiz.getDer())-this.Altura(this.raiz.getIz()));
                  //System.out.println("altura de " +this.raiz.getEmail() + ": "+this.raiz.getFe());
                   if (this.raiz.getFe() ==2)
    ...
    void RotacionID(ABBE n, ABBE n1)
        ...
        void RotacionDI(ABBE n, ABBE n1)
        {
          ...
          public void Graficar(ABBE raiz)
          {
              ...
              if(raiz!=null)
              {
                colector.append(raiz.ToString() + "[label = \" <f0> | <f1> ID: " + raiz.getID() +"\\Nombre: "+raiz.getNombre()+"\\Apellido: "+raiz.getApellido()+ " | <f2>\"];\n");
		...
		{       
          ...
          public StringBuilder Grafic(ABBE raIZ)
          {
              ...
              if (raIZ.getIz() != null)
                  rr.append(raiz.ToString() + "[label = \" <f0> | <f1> ID: " + raIZ.getIz().getID() +"\\Nombre: "+raIZ.getIz().getNombre()+"\\Apellido: "+raIZ.getIz().getApellido()+ " | <f2>\"];\n");
                  //rr.append(raIZ.getIz().ToString() + "[label = \" <f0> | <f1> " + raIZ.getIz().getEmail() + " | <f2>\"];\n");
              if (raIZ.getDer() != null)
                  rr.append(raiz.ToString() + "[label = \" <f0> | <f1> ID: " + raIZ.getDer().getID() +"\\Nombre: "+raIZ.getDer().getNombre()+"\\Apellido: "+raIZ.getDer().getApellido()+ " | <f2>\"];\n");
        ...
        private void SearchForEliminarion(ABBE raiz,ABBE raizabajo)
        {
            ...
            if(raizabajo.getDer()==null)
            {
                ...
                raiz.setApellido(raizabajo.getApellido());
        ...
        public void EliminarR(String id,ABBE raiz )
        {
            if(raiz==null)
            {
